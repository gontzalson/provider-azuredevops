...
// ResolveReferences of this Features.
func (mg *Features) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this PipelineSettings.
func (mg *PipelineSettings) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
