...
type PermissionsInitParameters_6 struct {
...
type PermissionsObservation_6 struct {
...
type PermissionsParameters_6 struct {
...
type PermissionsSpec struct {
	...
	ForProvider            PermissionsParameters_6 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PermissionsInitParameters_6 `json:"initProvider,omitempty"`
}

// PermissionsStatus defines the observed state of Permissions.
type PermissionsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PermissionsObservation_6 `json:"atProvider,omitempty"`
}
...
// Permissions is the Schema for the Permissionss API. Manages permissions for AzureDevOps Tagging
