...
// GetInitParameters of this Approval
func (tr *Approval) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Approval
func (tr *Approval) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
