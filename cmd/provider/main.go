...
import (
	...
	apisCluster "github.com/gontzalson/provider-azuredevops/apis/cluster"
	apisNamespaced "github.com/gontzalson/provider-azuredevops/apis/namespaced"
	"github.com/gontzalson/provider-azuredevops/config"
	"github.com/gontzalson/provider-azuredevops/internal/clients"
	controllerCluster "github.com/gontzalson/provider-azuredevops/internal/controller/cluster"
	controllerNamespaced "github.com/gontzalson/provider-azuredevops/internal/controller/namespaced"
	"github.com/gontzalson/provider-azuredevops/internal/features"
	"github.com/gontzalson/provider-azuredevops/internal/version"
)
...
func main() {
	...
	// Always set the controller-runtime logger to ensure logs are displayed
	// Use a less verbose logger in production mode
	ctrl.SetLogger(zl)
